export const quizFr = [
    {
        ...
        option3: "Calculateur",
        answered: false,
        comment: "Le philologue Jacques Perret a fait des recommandations pour un équivalent français au terme anglais “computer”. Bien qu’il recommanda “ordinatrice électronique”, IBM reteint le masculin “ordinateur”. “Calculateur“ ne figurait pas parmi ses propositions, IBM voulant justement s’éloigner de ce terme trop limitatif.",
        correct: false
    },{
        questionNumber: 8,
        ...
        option3: "Screenbook",
        answered: false,
        comment: "Arthur C. Clarke a bien appelé “Newspad“ la tablette décrite dans son roman. Kubrick l’a intégrée dans son film en lui donnant des dimensions similaires à l’iPad Pro et un écran plat bord à bord. Il aura donc fallu plus de 40 ans pour qu’il voit le jour.",
        correct: false
    },{
        questionNumber: 14,
        ...
        option3: "Le RGPD",
        answered: false,
        comment: "Le RGPD (Règlement Général sur la Protection de Données) est un ensemble de mesures destinées à protéger la vie privée des citoyens européens. Les entreprises défaillantes encourent une amende de 20 millions d’euros ou 4% de leur chiffre d’affaires. Ouch&thinsp;! Cette question, elle ne fait pas rire.",
        correct: false
    },{
        questionNumber: 15,
        ...
        option3: "36 ans",
        answered: false,
        comment: "Concerto a officiellement débuté en 1992. L’agence était à l’époque, pionnière dans le prepresse sur Mac. Dès 2011, elle s’intéresse aux applications pour iPad.<br/>Et si 2018 était l’année où l’agence entamait une collaboration avec vous&thinsp;?",
        correct: false
    }
]
