export const quizFr = [
    {
        ...
        option3: "Le teletext",
        answered: false,
        comment: "Après 190 ans de bons et loyaux services,  le dernier télégramme belge a été envoyé le 29 décembre 2017. Fax et télétexte sont toujours d’actualité.",
        correct: false
    },{
        questionNumber: 2,
        ...
        answered: false,
        comment: "LinkedIn, avec 106 millions d’utilisateurs actifs en 2017, se classe à la 18<sup>e</sup> position. Facebook est grand premier avec près de 2&nbsp;milliards d’utilisateurs.<br/><span class='source'>(source&nbsp;: smart insights)</span>",
        correct: false
    },{
        questionNumber: 5,
        ...
        answered: false,
        comment: "Depuis 2013, toutes les tranches d’âge ont atteint un plateau sauf les 65+ qui continuent de progresser.<br/><span class='source'>(source&nbsp;: smart insights)</span>",
        correct: false
    },{
        questionNumber: 6,
        ...
        option3: "Calculateur",
        answered: false,
        comment: "Le philologue Jacques Perret a fait des recommandations pour un équivalent français au terme anglais “computer”. Bien qu’il recommanda “ordinatrice électronique”, IBM retint le masculin “ordinateur”. “Calculateur“ ne figurait pas parmi ses propositions, IBM voulant justement s’éloigner de ce terme trop limitatif.",
        correct: false
    },{
        questionNumber: 8,
        ...
        questionNumber: 9,
        questionContent: "En Belgique, entre 2012 et 2017,  le score de crédibilité de Facebook",
        questionAnswer: 3,
        option1: "a augmenté de 38%",
        option2: "est resté stable",
        option3: "a diminué de 38%",
        answered: false,
        comment: "Avec un score de seulement 19% en 2017, Facebook affiche une perte de crédibilité de 38&nbsp;% en 5 ans. La radio conserve le plus haut indice de confiance, avec 69,4&nbsp;%.  Les publicités sont à moins de 10&nbsp;% de crédibilité, à égalité avec les partis politiques.<br/><span class='source'>(Source: Whyte corporate affairs)</span>",
        correct: false
    },{
        questionNumber: 10,
        ...
        answered: false,
        comment: "Même si c’est pour bientôt, personne n’est encore né en dehors de notre bonne vielle Terre&hellip; La génération alpha désigne les personnes nées après 2010.",
        correct: false
    },{
        questionNumber: 11, 
        ...
        option3: "Screenbook",
        answered: false,
        comment: "Arthur C. Clarke a appelé “Newspad“ la tablette décrite dans son roman. Kubrick l’a intégrée dans son film en lui donnant des dimensions similaires à l’iPad Pro et un écran plat bord à bord. Il aura donc fallu plus de 40 ans pour qu’il voit le jour.",
        correct: false
    },{
        questionNumber: 14,
        ...
        option3: "Le RGPD",
        answered: false,
        comment: "Le RGPD (Règlement Général sur la Protection de Données) est un ensemble de mesures destinées à protéger la vie privée des citoyens européens. Les entreprises défaillantes encourent une amende de 20 millions d’euros ou 4% de leur chiffre d’affaires. Ouch&nbsp;! Cette question, elle ne fait pas rire.",
        correct: false
    },{
        questionNumber: 15,
        ...
        option3: "36 ans",
        answered: false,
        comment: "Concerto a officiellement débuté en 1992. L’agence était à l’époque, pionnière dans le prépresse sur Mac. Dès 2011, elle s’intéresse aux applications pour iPad.<br/>Et si 2018 était l’année où l’agence entamait une collaboration avec vous&nbsp;?",
        correct: false
    }
]

const quizFrReducer = (state = quizFr, action) => {
    switch(action.type){
