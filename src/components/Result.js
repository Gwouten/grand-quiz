...
class Result extends React.Component {
    render(){
        const badFr = (
        <div>
            <h2 className="question__content header__text header__text--result">Ne nous voilons pas la face&nbsp;:<br/>ce n’est pas brillant.</h2>
                <p>Heureusement, vous n’êtes pas obligés de partager ce résultat. Et puis ce n’est pas grave, si vous arrivez à placer dans vos conversations les expressions “inbound“, “content marketing“, “storytelling“, “big data“ et “conversion“, vous ferez toujours bonne figure. Admettons aussi qu’il y avait pas mal de questions faisant référence au passé, alors que vous, vous êtes une personne résolument tournée vers l’avenir! Et puis, vous pouvez aussi rejouer&hellip;</p>
                ...
                <p>Nos calculs heuristiques ont déterminé qu’en travaillant avec Concerto en 2018, votre score passerait au-dessus de 15 l’année prochaine. À très bientôt&nbsp;?</p>
        </div>
        );
        ...
        <div>
            <h2 className="question__content header__text header__text--result">C’est bien. Vous avez plus que la moitié&hellip;</h2>
                ...
                <p>Et bien, oui c’est important&nbsp;! Nous vous connaissons, vous n’êtes pas du genre à vous contenter du moyen, du passable. Car il n’y pas pire : ni le talent de figurer les premiers, ni l’anticonformisme d’être parmi les derniers.</p>
