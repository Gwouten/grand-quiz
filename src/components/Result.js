...
class Result extends React.Component {
    render(){
        const bad = (
        <div>
            <h2>Ne nous voilons pas la face : ce n’est pas brillant.</h2>
        ...
        <p> Cependant notre système d’intelligence artificielle basée sur les réseaux neuronaux vous recommande une collaboration avec une agence de qualité.</p>
            <p>Nos calculs quantico-heuristiques ont déterminé qu’en travaillant avec Concerto en 2018, votre score passerait forcément au-dessus de 15 l’année prochaine. A très bientôt ?</p>
        </div>
        );

        const medium = (
        <div>
            <h2>C’est bien. Vous avez plus que la moitié…</h2>
                ...
                <p>Et bien, oui c’est important ! Nous vous connaissons, vous n’êtes pas du genre à vous contenter du moyen, du passable. Car il n’y pas pire : ni le talent d’être d’être parmi les premiers, ni l’anticonformisme de mener les derniers.</p>
                <p>Point de fade, de tiède ou de mou, il vous faut de l’extrême, du panache!</p>
                <p>Vous avez en vous le sens de l’excellence, le refus de la médiocrité, le besoin de dépassement. Ça tombe bien, nous aussi !  Et si nous nous rencontrions en 2018 ?</p>
        </div>
        );

        const good = (
        <div>
            <h2>Les chiffres ne mentent pas : vous faites partie de l’élite.</h2>
                ...
                <p>Mais attention, c’est parfois difficile d’être parmi les meilleurs. Vous avez sans doute déjà connu le syndrome du premier de classe : jalousie, incompréhension… Ne restez pas à vous apitoyer sur votre sort.</p>
        ...
        return (
        <div>
            <h1>Score: {this.props.score}/15</h1>
